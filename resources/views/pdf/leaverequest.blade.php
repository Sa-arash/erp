...
<body>
  ...
  <table class="no-border">
    <tr><td class="no-border" colspan="4" style="text-align: left;"><img src="logo.png" alt="ATGT Logo" style="height: 40px;"></td></tr>
    <tr><td class="header" colspan="4">Leave Request – R&amp;R/Home</td></tr>
  </table>
  ...
  <table>
    ...
    <tr>
      <td colspan="6">Are you aware of any circumstances that will delay or prevent your return to the site from leave?
        <div style="margin-top:5px;"><div class="checkbox"></div> Yes <div class="checkbox filled" style="margin-left:20px;"></div> No</div>
      </td>
    </tr>
    <tr><td colspan="6" style="height:30px;">If yes, please explain:</td></tr>
  </table>
  ...
  <table>
    <tr class="section-title"><td colspan="2">Leave Details</td></tr>
    <tr><td colspan="2" class="small-text">Use the following legend to annotate the leave pay status in the calendar below for all days off site:</td></tr>
    <tr>
      <td colspan="2" class="small-text">
        O = Regular Day Off, H = Holiday, CL = Casual (LN), ML = Medical Leave, BL = Bereavement,
        M = Marriage, TD = Travel Day, S = Sick, RR = Paid leave, LWOP = Leave without Pay, ML/PL = Maternity/Paternity
      </td>
    </tr>
    <tr>
      <td>
  ...
  <table>
    <tr class="section-title"><td colspan="4">Signatures</td></tr>
    <tr>
      <td>Employee Signature<br><div class="signature-space"></div></td>
      <td>Date<br><div class="signature-space"></div></td>
      <td>Supervisor's Signature<br><div class="signature-space"></div></td>
      <td>Date<br><div class="signature-space"></div></td>
    </tr>
    <tr>
      <td colspan="2">Admin/HR Dept Signature<br><div class="signature-space"></div></td>
      <td colspan="2">
        <div><div class="checkbox filled"></div> Approved</div>
        <div><div class="checkbox"></div> Denied</div>
