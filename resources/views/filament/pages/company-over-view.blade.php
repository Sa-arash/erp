                            ...
                            @foreach ($fillerArray as $key => $mount)
                                ...
                                @php
                                    ...
                                    $countPR = $company
                                        ...
                                        ->count();
                                    $totalPR += $countPR;
                                    $sumPO = App\Models\PurchaseOrder::where('company_id', $company->id)
                                    ...
                                    $incomeData = collect(range(0, count($fillerArray) - 1)) // ایجاد کالکشن از تعداد آیتم‌های fillerArray
                                        ->map(function ($index) use ($monthArray ,$company) {
                                            return $company
                                    ...
                                    $RecivableData = collect(range(0, count($fillerArray) - 1))
                                        ->map(function ($index) use ($monthArray ,$company) {
                                            ...
                                            $receivableAccounts = $company->accounts->where(
                                                'stamp',
                                                'Accounts Receivable',
                                            );
                                    ...
                                    $PayableData = collect(range(0, count($fillerArray) - 1))
                                        ->map(function ($index) use ($monthArray ,$company) {
                                            ...
                                            $payableAccounts = $company->accounts->where(
                                                'stamp',
                                                'Accounts Payable',
                                            );
