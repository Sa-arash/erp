...
class PartiesResource extends Resource
{
    ...
    {
        return \auth()->user()->can('view_any_parties'); // TODO: Change the autogenerated stub
    }
    ...
    {
        return \auth()->user()->can('update_parties'); // TODO: Change the autogenerated stub
    }
                ...
                Forms\Components\TextInput::make('account_code_vendor')
                    ...
                    ->default(function () {
                        if (Parties::query()->where('company_id', getCompany()->id)->where('type', 'vendor')->latest()->first()) {
                            return generateNextCode(Parties::query()->where('company_id', getCompany()->id)->where('type', 'vendor')->orderBy('id','desc')->first()->account_code_vendor);
                        } else {
                            return "001";
                        }
                ...
                Forms\Components\TextInput::make('account_code_customer')->unique('accounts', 'code', ignoreRecord: true)
                    ...
                    ->default(function () {
                        if (Parties::query()->where('company_id', getCompany()->id)->where('type', 'customer')->latest()->first()) {
                            return generateNextCode(Parties::query()->where('company_id', getCompany()->id)->where('type', 'customer')->orderBy('id','desc')->first()->account_code_customer);
                        } else {
                            return "001";
                        }
    ...
    public static function table(Table $table): Table
    {
        return $table
            ...
            ->columns([
                ...
                Tables\Columns\TextColumn::make('type')->state(fn($record)=>str($record->type)->title()),
