...
//                                    .Currency::query()->firstWhere('id',dd($get('currency_id'))
    ...
    {
        return parent::getEloquentQuery()->with(['employee', 'employee.position', 'items', 'currency', 'approvals', 'approvals.employee', 'quotations']); // TODO: Change the autogenerated stub
    }
