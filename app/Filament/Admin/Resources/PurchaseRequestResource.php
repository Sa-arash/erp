                ...
                Section::make('')->schema([
                    ...
                    TableRepeater::make('items')->relationship('items') ->addActionLabel('Add')
                        ...
                        ->schema([
                            ...
                            Forms\Components\Textarea::make('description')->rows(1)->label(' Product Name and Description')->columnSpan(['default'=>4,'sm'=>3,'md'=>3,'xl'=>4])->required(),
...
//                                    .Currency::query()->firstWhere('id',dd($get('currency_id'))
    ...
    {
        return parent::getEloquentQuery()->with(['employee', 'employee.position', 'items', 'currency', 'approvals', 'approvals.employee', 'quotations'])->withSum('purchaseOrderItem', 'total'); // TODO: Change the autogenerated stub
    }
    ...
    public static function table(Table $table): Table
    {
        return $table->defaultSort('id', 'desc')
            ->columns([
                ...
                Tables\Columns\TextColumn::make('description')->searchable()->label('PR Description')->tooltip(fn($record) => $record->description)->limit(30),
                Tables\Columns\TextColumn::make('employee.department.title'),
