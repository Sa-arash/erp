    ...
    public function table(Table $table): Table
    {
        ...
        return $table->query(
            Product::select('products.*')
                ...
                ->groupBy('products.id','product_category_id','deleted_at', 'unit_id', 'created_at', 'updated_at', 'products.stock_alert_threshold', 'products.product_type', 'products.title', 'products.second_title', 'products.image', 'products.department_id', 'products.account_id', 'products.sku', 'products.sub_account_id', 'products.description', 'products.company_id')
