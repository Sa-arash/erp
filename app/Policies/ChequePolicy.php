...
class ChequePolicy
{
    ...
    {
        return $user->can('view_any_cheque');
    }
    ...
    {
        return $user->can('delete_any_cheque');
    }
    ...
    {
        return $user->can('force_delete_cheque');
    }
    ...
    {
        return $user->can('restore_cheque');
    }
