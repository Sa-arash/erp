...
class TypeleavePolicy
{
    ...
    {
        return $user->can('force_delete_any_type::leave');
    }
    ...
    {
        return $user->can('restore_any_type::leave');
    }
    ...
    {
        return $user->can('replicate_type::leave');
    }
    ...
    {
        return $user->can('reorder_type::leave');
    }
}
