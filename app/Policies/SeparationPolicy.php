...
class SeparationPolicy
{
    ...
    {
        return $user->can('view_any_separation');
    }
    ...
    {
        return $user->can('view_separation');
    }
    ...
    {
        return $user->can('create_separation');
    }
    ...
    {
        return $user->can('update_separation');
    }
    ...
    {
        return $user->can('delete_separation');
    }
    ...
    {
        return $user->can('delete_any_separation');
    }

    /**
     * Determine whether the user can permanently delete.
     */
    public function forceDelete(User $user, Separation $separation): bool
    {
        return $user->can('force_delete_separation');
    }
     ...
     */
    public function restore(User $user, Separation $separation): bool
    {
        return $user->can('restore_separation');
    }
